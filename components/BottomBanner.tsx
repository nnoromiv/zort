...
const BottomBanner = () => {
  return (
    <div className='px-3 flex flex-col justify-center items-center bg-light-white gap-2 py-36 max-[1026px]:py-10'>
        <h1 className='font-bold text-black text-6xl max-xl:text-4xl max-[769px]:!text-2xl max-sm:!text-sm'>The modern way to track and manage your bets.</h1>
        ...
        <div className='flex gap-5 items-center justify-center max-[376px]:flex-col w-full'>
            <IButton buttonText='Sign Up Now' className="w-60 max-[769px]:w-40 max-[376px]:!w-full transform rounded-lg bg-white px-6 py-2 font-medium !text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-black hover:!text-white border-1 border-white dark:bg-white dark:text-black dark:hover:bg-gray-200" />
